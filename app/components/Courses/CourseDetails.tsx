        ...
        <div className="w-[90%] 800px:w-[90%] m-auto py-5 h-auto text-black dark:text-white">
          <div className="w-full flex flex-col-reverse 800px:flex-row">
            <div className="w-full 800px:w-[65%] 800px:pr-5">
              ...
              {data.perrequistites?.map((item: any, index: number) => (
                      ...
                      {item?.questions?.questionReplies.map((i: any, index: number) => (
                        <div className="w-full flex 800px:ml-16 my-5" key={index}>
                          <div className="w-[50px] h-[50px]">
                            <Image
                              src={
                                i.questions?.questionReplies.user?.avatar
                                  ? i.questions?.questionReplies?.user?.avatar.url
                                  : "https://res.cloudinary.com/dshp9jnuy/image/upload/v1665822253/avatars/nrxsg8sd9iy10bbsoenn.png"
                              }
                              width={50}
                              height={50}
                ...
                <div className="flex items-center">
                  {isPurchased ? (
                    <>
                      ...
                      <div
                        className={`${style.button} !w-[200px] my-5 font-Poppins ml-2 cursor-pointer !bg-[crimson] text-white`}
