...
const CourseCard: FC<Props> = ({ isProfile, item }) => {
    return (
        <Link href={!isProfile ? `course/${item._id}` : `course-access/${item._id}`}>
            <div className="w-full min-h-[35vh] dark:bg-slate-500 dark:opacity-0.2  border dark:border-[#ffffff1d] border-[#00000015] dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm dark:shadow-inner">
